...
public class LiveListViewChannelAdapter extends BaseAdapter {
    ...
    public LiveListViewChannelAdapter(Context mContext, ArrayList<String> list, int selection) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_list_channel, parent, false);
